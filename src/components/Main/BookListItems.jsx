      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-1">
            ...
            <span className="text-xs lg:text-sm">({stars.length} Star)</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 text-xs lg:text-sm">
          ...
          <button
            ...
            className={`flex min-w-[132px] items-center justify-center gap-1 rounded-md ${
              !isFavourite
                ? "bg-[#1C4336]/[14%] hover:bg-[#1C4336]/[24%]"
                : "bg-[#DC2954]/[14%] text-[#DC2954] "
            } py-1.5 text-[#1C4336] transition-all  lg:py-1.5`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill={isFavourite ? "#DC2954" : "currentColor"}
              viewBox="0 0 24 24"
              strokeWidth="1.5"
              className="h-5 w-5"
            >
